...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', async function(event) {
        ...
        // 2. Obter o valor digitado pelo usuário no campo de texto.
        const descrpition = textArea.value.trim();
        ...
        try {
            ...
            const response = await fetch('https://jyoao.app.n8n.cloud/webhook-test/Background-generetion', {
                method: 'POST',
                headers: {'Content-type': 'application/json'},
                body: JSON.stringify({descrpition})
            })
